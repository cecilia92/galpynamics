...
class truncated_alfabeta_halo(halo):
    ...
    def __init__(self,d0,rs,alfa,beta,rcut,e=0,mcut=100):
        ...
        self.beta=beta
        self.rcut=rcut
        super(truncated_alfabeta_halo,self).__init__(d0=d0,rs=rs,e=e,mcut=mcut) #????????? qual è il criterio per mettere un parametro dentro a questa parentesi o fare self.param_x=param_x???
